namespace EmployeeSalaryApp.Services.Employee
{
    using System.Linq;
    ...
    {
        private readonly CustomWebApplicationFactory db;
        private readonly ITaxCalculator? taxCalculator;

        public EmployeeService(CustomWebApplicationFactory db, ITaxCalculator? taxCalculator)
        {
            this.db = db;
            this.taxCalculator = taxCalculator;
        }

        public async Task<Result> CreateAsync(CreateFormModel model)
        {
